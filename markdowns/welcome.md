...
::: Scripts
La tabla **Usuario** tendrá como llave primaria el campo ID, los campos ID y Nombre tendran un **constraint** de tipo **NOT NULL** TECHIO> message [OPTIONS] <NOT NULL> el cual sirve para garantizar que esos campos siempre tendrán valor.
